                          ...
                          <td className="px-5 py-3.5">
                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              <WhatsAppButton
                                ...
                                mensaje={`Hola ${c.tenant.fullName.split(" ")[0]}, te recordamos que tu cobro de ${c.unit.currency} ${c.amount.toLocaleString()} por ${formatPeriod(c.period)} vence el ${formatFecha(c.dueDate)}. Pagá aquí: ${linkPago}`}
                                size="icon"
                              />
